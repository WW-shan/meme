...
Generated: `2026-05-25 18:16:52.236333`
...
- Bucket net profit: `{"profitable_exit": 3.7973257314077554e-05}`
...
- Primary net profit: `3.7973257314077554e-05` BNB

## Symbols

- Symbols by label: `{"profitable_exit": ["尽调中心"]}`

## Rejected Signal Paths

- Signal decisions: `569`; per-token candidates: `18`
- Barrier classes: `{"fast_profit": 2, "fast_profit_then_collapse": 5, "flat_timeout": 8, "slow_runner": 1, "stop_first": 2}`
- Recommended policies: `{"conditional_slow_hold": 1, "quick_take_profit": 7, "skip": 10}`
