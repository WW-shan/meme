...
Generated: `2026-05-26 01:02:38.087709`
...
- Net profit: `-2.5319026715831417e-05` BNB
- Failure labels: `{"dead_flow_timeout": 1}`
- Close reasons: `{"TIME_EXIT": 1}`
- Lifecycle price paths: `1/1` with missing path count `0`
- Bucket net profit: `{"dead_flow_timeout": -2.5319026715831417e-05}`

## Near Threshold Split

- Near trades: `1`; labels: `{"dead_flow_timeout": 1}`
- Near net profit: `-2.5319026715831417e-05` BNB
- Primary trades: `0`; labels: `{}`
- Primary net profit: `0` BNB

## Symbols

- Symbols by label: `{"dead_flow_timeout": ["CHILLCAT"]}`

## Rejected Signal Paths

- Signal decisions: `1020`; per-token candidates: `34`
- Barrier classes: `{"fast_profit": 1, "fast_profit_then_collapse": 3, "flat_timeout": 20, "slow_runner": 1, "stop_first": 9}`
- Recommended policies: `{"conditional_slow_hold": 1, "quick_take_profit": 4, "skip": 29}`
