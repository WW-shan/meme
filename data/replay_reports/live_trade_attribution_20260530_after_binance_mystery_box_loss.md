...
Generated: `2026-05-30 14:23:55.055404`
...
- Net profit: `-2.4987972169378226e-05` BNB
- Failure labels: `{"dead_flow_timeout": 1}`
- Close reasons: `{"TIME_EXIT": 1}`
- Lifecycle price paths: `1/1` with missing path count `0`
- Bucket net profit: `{"dead_flow_timeout": -2.4987972169378226e-05}`

## Near Threshold Split

- Near trades: `1`; labels: `{"dead_flow_timeout": 1}`
- Near net profit: `-2.4987972169378226e-05` BNB
- Primary trades: `0`; labels: `{}`
- Primary net profit: `0` BNB

## Symbols

- Symbols by label: `{"dead_flow_timeout": ["币安盲盒"]}`

## Rejected Signal Paths

- Signal decisions: `4642`; per-token candidates: `311`
- Barrier classes: `{"fast_profit": 20, "fast_profit_then_collapse": 13, "flat_timeout": 202, "slow_runner": 14, "stop_first": 62}`
- Recommended policies: `{"conditional_slow_hold": 14, "quick_take_profit": 33, "skip": 264}`
- Missing/unemitted candidates: `231`
