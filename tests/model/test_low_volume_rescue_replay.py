...
def _sample(
    ...
    recent_seller_reentry_ratio_30s=0.0,
...
class TestLowVolumeRescueReplay(unittest.TestCase):
    ...
    def test_primary_score_rescue_quick_take_profit_requires_flow_overlap_ceilings_when_configured(self):
        ...
        episodes = [[
            _sample(
                ...
                buy_sell_overlap_ratio_60s=0.6,
                recent_seller_reentry_ratio_30s=0.2,
            ),
            _sample(sample_time=130, price=1.25, volume_30s=3.2, price_volatility=0.32),
        ]]
        ...
        self.assertEqual(result["quick_profit_overlay_entry_count"], 0)
        self.assertEqual(result["quick_profit_overlay_reject_count"], 1)
        self.assertEqual(result["buy_quick_profit_overlay_max_buy_sell_overlap_ratio_60s"], 0.5)
        self.assertEqual(result["buy_quick_profit_overlay_max_recent_seller_reentry_ratio_30s"], 0.5)

    def test_primary_score_rescue_quick_take_profit_requires_min_flow_event_count_when_configured(self):
        m = _load_module()
        episodes = [[
            _sample(
                sample_time=120,
        ...
        result = m._run_eval_replay(
            ...
            buy_quick_profit_overlay_take_profit_pct=0.25,
            buy_quick_profit_overlay_max_hold_seconds=120.0,
            buy_quick_profit_overlay_min_flow_event_count_30s=2,
            position_fraction=0.1,
            include_trade_log=True,
        )
        ...
        self.assertEqual(result["quick_profit_overlay_entry_count"], 0)
        self.assertEqual(result["quick_profit_overlay_reject_count"], 1)
        self.assertEqual(result["buy_quick_profit_overlay_min_flow_event_count_30s"], 2.0)

    def test_primary_score_rescue_quick_take_profit_reads_flow_event_count_from_meta_only(self):
        m = _load_module()
        first = _sample(sample_time=120, price=1.0, volume_30s=3.0, price_volatility=0.30)
        first["features"]["flow_event_count_30s"] = 99
        del first["meta"]["flow_event_count_30s"]
        episodes = [[
            first,
            _sample(sample_time=130, price=1.25, volume_30s=3.2, price_volatility=0.32),
        ]]
    ...
    def test_primary_score_rescue_quick_take_profit_accepts_flow_overlap_boundaries(self):
        m = _load_module()
        episodes = [[
            _sample(
                sample_time=120,
    ...
    def test_primary_score_rescue_quick_take_profit_rejects_invalid_flow_overlap_ceilings(self):
        m = _load_module()
        episodes = [[
            _sample(sample_time=120, price=1.0, volume_30s=3.0, price_volatility=0.30),
            _sample(sample_time=130, price=1.25, volume_30s=3.2, price_volatility=0.32),
        ...
        invalid_overrides = [
            {"buy_quick_profit_overlay_max_buy_sell_overlap_ratio_60s": -0.01},
            {"buy_quick_profit_overlay_max_buy_sell_overlap_ratio_60s": float("nan")},
            {"buy_quick_profit_overlay_max_buy_sell_overlap_ratio_60s": 1.01},
            {"buy_quick_profit_overlay_min_flow_event_count_30s": -0.01},
            {"buy_quick_profit_overlay_min_flow_event_count_30s": float("nan")},
            {"buy_quick_profit_overlay_max_recent_seller_reentry_ratio_30s": -0.01},
            {"buy_quick_profit_overlay_max_recent_seller_reentry_ratio_30s": float("inf")},
            {"buy_quick_profit_overlay_max_recent_seller_reentry_ratio_30s": 1.01},
        ]
