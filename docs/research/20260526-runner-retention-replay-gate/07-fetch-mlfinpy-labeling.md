...
Hide table of contents sidebar
 ...
 [Skip to content](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#furo-main-content)

Toggle site navigation sidebar

 

[Mlfin.py](https://mlfinpy.readthedocs.io/en/latest/index.html)
...
*   [User Guide](https://mlfinpy.readthedocs.io/en/latest/UserGuide.html)
*   [Financial Data Structures](https://mlfinpy.readthedocs.io/en/latest/FinancialDataStructure.html)
*   [Fractionally Differentiated](https://mlfinpy.readthedocs.io/en/latest/FractionalDifferentiated.html)
*   [Data Filtering](https://mlfinpy.readthedocs.io/en/latest/Filtering.html)
*   [Data Labelling](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#)
*   [Data Sampling](https://mlfinpy.readthedocs.io/en/latest/Sampling.html)

Other information

*   [FAQs](https://mlfinpy.readthedocs.io/en/latest/FAQ.html)
*   [Roadmap and Changelog](https://mlfinpy.readthedocs.io/en/latest/Roadmap.html)
*   [Contributing](https://mlfinpy.readthedocs.io/en/latest/Contributing.html)
*   [About](https://mlfinpy.readthedocs.io/en/latest/About.html)

[![Image 1: Sponsored: MongoDB](https://media.ethicalads.io/images/2023/07/mongodb-codedark-240x180_KOok2ZA.png)](https://server.ethicalads.io/proxy/click/10499/019e4a26-1fd4-76f1-af3d-ff0f91e5f180/)

[Develop and launch modern apps with MongoDB Atlas, a resilient data platform.](https://server.ethicalads.io/proxy/click/10499/019e4a26-1fd4-76f1-af3d-ff0f91e5f180/)

www.mongodb.com

[Ads by EthicalAds](https://www.ethicalads.io/advertisers/topics/data-science/?ref=ea-image)

![Image 2](https://server.ethicalads.io/proxy/view/10499/019e4a26-1fd4-76f1-af3d-ff0f91e5f180/)

[Back to top](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#)

[View this page](https://mlfinpy.readthedocs.io/en/latest/_sources/Labelling.rst.txt "View this page")
...
# Data Labelling[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#data-labelling "Link to this heading")
...
## Raw Returns[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#raw-returns "Link to this heading")
...
The simple return for an observation with price $p_{t}$ at time $t$ relative to its price at time $t - 1$ is as follows:
...
$$
r_{t} = l o g \left(\right. p_{t} \left.\right) - l o g \left(\right. p_{t - 1} \left.\right)
$$

The label $L_{t}$ is simply equal to $r_{t}$, or to the sign of $r_{t}$, if binary labeling is desired.

> $$
> \begin{matrix}L_{t} = \begin{cases} - 1 & \textrm{ } \text{if} \textrm{ } \textrm{ } r_{t} < 0 \\ 0 & \textrm{ } \text{if} \textrm{ } \textrm{ } r_{t} = 0 \\ 1 & \textrm{ } \text{if} \textrm{ } \textrm{ } r_{t} > 0 \end{cases}\end{matrix}
> $$
...
[![Image 3: raw returns image](https://mlfinpy.readthedocs.io/en/latest/_images/Raw_returns_distribution.png)](https://mlfinpy.readthedocs.io/en/latest/_images/Raw_returns_distribution.png)

Distribution of logarithmic returns on MSFT.[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id25 "Link to this image")

### Implementation[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#module-mlfinpy.labeling.raw_return "Link to this heading")
...
mlfinpy.labeling.raw_return.raw_return(_prices:Series|DataFrame_, _binary:bool=False_, _logarithmic:bool=False_, _resample\_by:str|None=None_, _lag:bool=True_)→Series|DataFrame[[source]](https://mlfinpy.readthedocs.io/en/latest/_modules/mlfinpy/labeling/raw_return.html#raw_return)[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.raw_return.raw_return "Link to this definition")
Raw returns labeling method.
...
#### Parameters[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#parameters "Link to this heading")
...
#### Returns[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#returns "Link to this heading")
...
### Example[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#example "Link to this heading")
...
## Fixed Time Horizon[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#fixed-time-horizon "Link to this heading")
...
Fixed time horizon is a common method used in labeling financial data, usually applied on time bars. The rate of return relative to $t_{0}$ over time horizon $h$, assuming that returns are lagged, is calculated as follows (M.L. de Prado, Advances in Financial Machine Learning, 2018):

$$
r_{t 0 , t 1} = \frac{p_{t 1}}{p_{t 0}} - 1
$$

Where $t_{1}$ is the time bar index after a fixed horizon has passed, and $p_{t 0} , p_{t 1}$ are prices at times $t_{0} , t_{1}$. This method assigns a label based on comparison of rate of return to a threshold $\tau$

> $$
> \begin{matrix}L_{t 0 , t 1} = \begin{cases} - 1 & \textrm{ } \text{if} \textrm{ } \textrm{ } r_{t 0 , t 1} < - \tau \\ 0 & \textrm{ } \text{if} \textrm{ } \textrm{ } - \tau \leq r_{t 0 , t 1} \leq \tau \\ 1 & \textrm{ } \text{if} \textrm{ } \textrm{ } r_{t 0 , t 1} > \tau \end{cases}\end{matrix}
> $$
...
[![Image 4: fixed horizon example](https://mlfinpy.readthedocs.io/en/latest/_images/fixed_horizon_labels_example.png)](https://mlfinpy.readthedocs.io/en/latest/_images/fixed_horizon_labels_example.png)

Distribution of labels on standardized returns on closing prices of SPY.[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id26 "Link to this image")
...
*   **Advances in Financial Machine Learning, Chapter 3.2**_by_ Marcos Lopez de Prado (p. 43-44).

*   **Machine Learning for Asset Managers, Chapter 5.2**_by_ Marcos Lopez de Prado (p. 65-66).

### Implementation[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id2 "Link to this heading")
...
mlfinpy.labeling.fixed_time_horizon.fixed_time_horizon(_prices:Series|DataFrame_, _threshold:float|Series|None=0_, _resample\_by:str|None=None_, _lag:bool|None=True_, _standardized:bool|None=False_, _window:int|None=None_)→Series|DataFrame[[source]](https://mlfinpy.readthedocs.io/en/latest/_modules/mlfinpy/labeling/fixed_time_horizon.html#fixed_time_horizon)[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.fixed_time_horizon.fixed_time_horizon "Link to this definition")
Fixed-Time Horizon Labeling Method.
...
#### Parameters[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id3 "Link to this heading")
...
#### Returns[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id5 "Link to this heading")
...
### Example[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id6 "Link to this heading")
...
## Triple-Barrier and Meta-Labelling[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#triple-barrier-and-meta-labelling "Link to this heading")
...
### Triple-Barrier Method[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#triple-barrier-method "Link to this heading")
...
[![Image 5: _images/triple_barrier.png](https://mlfinpy.readthedocs.io/en/latest/_images/triple_barrier.png)](https://mlfinpy.readthedocs.io/en/latest/_images/triple_barrier.png)
...
### Meta-Labeling[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#meta-labeling "Link to this heading")
...
#### Meta-Labeling User Guide[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#meta-labeling-user-guide "Link to this heading")

Binary classification problems present a trade-off between type-I errors (false positives) and type-II errors (false negatives). In general, increasing the true positive rate of a binary classifier will tend to increase its false positive rate. The receiver operating characteristic (ROC) curve of a binary classifier measures the cost of increasing the true positive rate, in terms of accepting higher false positive rates.

[![Image 6: _images/confusion_matrix.png](https://mlfinpy.readthedocs.io/en/latest/_images/confusion_matrix.png)](https://mlfinpy.readthedocs.io/en/latest/_images/confusion_matrix.png)
...
#### Model Architecture[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#model-architecture "Link to this heading")
...
[![Image 7: _images/meta_labeling_architecture.png](https://mlfinpy.readthedocs.io/en/latest/_images/meta_labeling_architecture.png)](https://mlfinpy.readthedocs.io/en/latest/_images/meta_labeling_architecture.png)
### Implementation[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id7 "Link to this heading")

The following functions are used for the triple-barrier method which works in tandem with meta-labeling.

mlfinpy.labeling.labeling.add_vertical_barrier(_t\_events_, _close_, _num\_days=0_, _num\_hours=0_, _num\_minutes=0_, _num\_seconds=0_)[[source]](https://mlfinpy.readthedocs.io/en/latest/_modules/mlfinpy/labeling/labeling.html#add_vertical_barrier)[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.labeling.add_vertical_barrier "Link to this definition")
...
#### Parameters[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id8 "Link to this heading")
...
#### Returns[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id9 "Link to this heading")

verticle_barriers pd.Series
Timestamps of vertical barriers.

#### Notes[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#notes "Link to this heading")

Advances in Financial Machine Learning, Snippet 3.4, page 49.

mlfinpy.labeling.labeling.get_events(_close:Series_, _t\_events:Series_, _pt\_sl:List[float]_, _target:Series_, _min\_ret:float_, _num\_threads:int_, _vertical\_barrier\_times:Series|bool=False_, _side\_prediction:Series|None=None_, _verbose:bool=True_)→DataFrame[[source]](https://mlfinpy.readthedocs.io/en/latest/_modules/mlfinpy/labeling/labeling.html#get_events)[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.labeling.get_events "Link to this definition")
...
#### Parameters[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id10 "Link to this heading")

close pd.Series
Close prices

t_events pd.Series
of t_events. These are timestamps that will seed every triple barrier. These are the timestamps selected by the sampling procedures discussed in Chapter 2, Section 2.5. Eg: CUSUM Filter
...
target pd.Series
of values that are used (in conjunction with pt_sl) to determine the width of the barrier. In this program this is daily volatility series.
...
#### Returns[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id11 "Link to this heading")
...
mlfinpy.labeling.labeling.get_bins(_triple\_barrier\_events:DataFrame_, _close:Series_)→DataFrame[[source]](https://mlfinpy.readthedocs.io/en/latest/_modules/mlfinpy/labeling/labeling.html#get_bins)[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.labeling.get_bins "Link to this definition")
...
#### Parameters[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id12 "Link to this heading")

triple_barrier_events pd.DataFrame
DataFrame returned by ‘get_events’ with columns: - index: event starttime - vertical_barriers: event endtime - trgt: event target - side (optional): position side Case 1: (‘side’ not in events): bin in (-1,1) <-label by price action. Case 2: (‘side’ in events): bin in (0,1) <-label by pnl (meta-labeling).

close pd.Series
Close prices series.

#### Returns[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id13 "Link to this heading")

out_df pd.DataFrame
Meta-labeled events.

#### Notes[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id14 "Link to this heading")

Advances in Financial Machine Learning, Snippet 3.7, page 51.

mlfinpy.labeling.labeling.drop_labels(_events:DataFrame_, _min\_pct:float=0.05_)→DataFrame[[source]](https://mlfinpy.readthedocs.io/en/latest/_modules/mlfinpy/labeling/labeling.html#drop_labels)[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.labeling.drop_labels "Link to this definition")
This function recursively eliminates rare observations.

#### Parameters[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id15 "Link to this heading")
...
#### Returns[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id16 "Link to this heading")

pd.DataFrame
Events.

#### Notes[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id17 "Link to this heading")

Advances in Financial Machine Learning, Snippet 3.8 page 54.

### Example[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id18 "Link to this heading")
...
## Trend Scanning[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#trend-scanning "Link to this heading")

[![Image 8: _images/trend_scanning_plot.png](https://mlfinpy.readthedocs.io/en/latest/_images/trend_scanning_plot.png)](https://mlfinpy.readthedocs.io/en/latest/_images/trend_scanning_plot.png)
...
### Implementation[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id19 "Link to this heading")
...
mlfinpy.labeling.trend_scanning.trend_scanning_labels(_price\_series:Series_, _t\_events:list|None=None_, _look\_forward\_window:int=20_, _min\_sample\_length:int=5_, _step:int=1_)→DataFrame[[source]](https://mlfinpy.readthedocs.io/en/latest/_modules/mlfinpy/labeling/trend_scanning.html#trend_scanning_labels)[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.trend_scanning.trend_scanning_labels "Link to this definition")
...
#### Parameters[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id22 "Link to this heading")
...
#### Returns[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id23 "Link to this heading")
...
### Example[¶](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id24 "Link to this heading")
...
[Next Data Sampling](https://mlfinpy.readthedocs.io/en/latest/Sampling.html)[Previous Data Filtering](https://mlfinpy.readthedocs.io/en/latest/Filtering.html)
...
*   [Data Labelling](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#)
    *   [Raw Returns](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#raw-returns)
        *   [Implementation](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#module-mlfinpy.labeling.raw_return)
            *   [`raw_return()`](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.raw_return.raw_return)

        *   [Example](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#example)

    *   [Fixed Time Horizon](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#fixed-time-horizon)
        *   [Implementation](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id2)
            *   [`fixed_time_horizon()`](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.fixed_time_horizon.fixed_time_horizon)

        *   [Example](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id6)

    *   [Triple-Barrier and Meta-Labelling](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#triple-barrier-and-meta-labelling)
        *   [Triple-Barrier Method](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#triple-barrier-method)
        *   [Meta-Labeling](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#meta-labeling)
            *   [Meta-Labeling User Guide](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#meta-labeling-user-guide)
            *   [Model Architecture](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#model-architecture)

        *   [Implementation](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id7)
            *   [`add_vertical_barrier()`](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.labeling.add_vertical_barrier)
            *   [`get_events()`](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.labeling.get_events)
            *   [`get_bins()`](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.labeling.get_bins)
            *   [`drop_labels()`](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.labeling.drop_labels)

        *   [Example](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id18)

    *   [Trend Scanning](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#trend-scanning)
        *   [Implementation](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id19)
            *   [`trend_scanning_labels()`](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#mlfinpy.labeling.trend_scanning.trend_scanning_labels)

        *   [Example](https://mlfinpy.readthedocs.io/en/latest/Labelling.html#id24)
