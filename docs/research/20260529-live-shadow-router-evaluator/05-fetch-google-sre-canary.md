...
1. [Table of Contents](/workbook/table-of-contents/)
2. [Foreword I](/workbook/foreword-I/)
3. [Foreword II](/workbook/foreword-II/)
4. [Preface](/workbook/preface/)
5. [1. How SRE Relates to DevOps](/workbook/how-sre-relates/)
6. [Part I - Foundations](/workbook/part-I-foundations/)
7. [2. Implementing SLOs](/workbook/implementing-slos/)
8. [3. SLO Engineering Case Studies](/workbook/slo-engineering-case-studies/)
9. [4. Monitoring](/workbook/monitoring/)
10. [5. Alerting on SLOs](/workbook/alerting-on-slos/)
11. [6. Eliminating Toil](/workbook/eliminating-toil/)
12. [7. Simplicity](/workbook/simplicity/)
13. [Part II - Practices](/workbook/part-II-practices/)
14. [8. On-Call](/workbook/on-call/)
15. [9. Incident Response](/workbook/incident-response/)
16. [10. Postmortem Culture: Learning from Failure](/workbook/postmortem-culture/)
17. [11. Managing Load](/workbook/managing-load/)
18. [12. Introducing Non-Abstract Large System Design](/workbook/non-abstract-design/)
19. [13. Data Processing Pipelines](/workbook/data-processing/)
20. [14. Configuration Design and Best Practices](/workbook/configuration-design/)
21. [15. Configuration Specifics](/workbook/configuration-specifics/)
22. [16. Canarying Releases](/workbook/canarying-releases/)
23. [Part III - Processes](/workbook/part-III-processes/)
24. [17. Identifying and Recovering from Overload](/workbook/overload/)
25. [18. SRE Engagement Model](/workbook/engagement-model/)
26. [19. SRE: Reaching Beyond Your Walls](/workbook/reaching-beyond/)
27. [20. SRE Team Lifecycles](/workbook/team-lifecycles/)
28. [21. Organizational Change Management in SRE](/workbook/organizational-change/)
29. [Conclusion](/workbook/conclusion/)
30. [Appendix A. Example SLO Document](/workbook/slo-document/)
31. [Appendix B. Example Error Budget Policy](/workbook/error-budget-policy/)
32. [Appendix C. Results of Postmortem Analysis](/workbook/postmortem-analysis/)
33. [Index](/workbook/index/)
34. [About the Editors](/workbook/editors/)
35. [Colophon](/workbook/colophon/)
...
* A method to deploy the canary change to a subset of the population of the service.[2](#ch16fn2)
...
This is a very simple model that assumes uniform load. It also assumes that we can spend our entire error budget (beyond what we’ve already included in the organic measurement of current availability) on canaries. Rather than actual availability, here we consider only unavailability introduced by new releases. Our model also assumes a 100% failure rate because this is a worst-case scenario.[3](#ch16fn3) It is likely that defects in the canary deployment will not affect 100% of system usage. We also allow overall system availability to go below SLO for the duration of the canary deployment.[4](#ch16fn4)

This model has clear flaws, but is a solid starting point that you can adjust to match business needs.[5](#ch16fn5) We recommend using the simplest model that meets your technical and business objectives. In our experience, focusing on making the model as technically correct as possible often leads to overinvestment in modeling. For services with high rates of complexity, overly complex models can lead to incessant model tuning for no real benefit.
...
For basic evaluation, we do not need a terribly large canary population in order to detect key critical conditions.[6](#ch16fn6) However, a representative canary process requires decisions across many dimensions:
...
* Performance defects typically manifest only under heavy load,[7](#ch16fn7) so deploying at an off-peak time likely wouldn’t trigger performance-related defects.
...
[1](#ch16fn1-marker)The authors of this chapter are fans of Jez Humble and David Farley's book Continuous Delivery: Reliable Software Releases Through Build, Test, and Deployment Automation (Boston: Pearson, 2011).

[2](#ch16fn2-marker)The fraction of total service load you run on the canary should be proportional to the size of the canary population.

[3](#ch16fn3-marker)At least as far as availability is concerned. This analysis obviously does not cover the impact of incidents, such as a data leak.

[4](#ch16fn4-marker)For a sufficiently small canary, where the fraction of service equals the difference between actual availability and SLO, we can canary nonstop with confidence. This is our use of the error budget.

[5](#ch16fn5-marker)As British statistician George Box said, “Essentially, all models are wrong, but some are useful.” George E. P. Box and Norman R. Draper, Empirical Model-Building and Response Surfaces (New York: John Wiley and Sons, 1987).

[6](#ch16fn6-marker)See a discussion of real-world outages at [https://bit.ly/2LgorFz](https://www.usenix.org/conference/osdi14/technical-sessions/presentation/yuan).

[7](#ch16fn7-marker)For example, consider resource contention problems, such as database write conflicts or locking in multithreaded applications.

[8](#ch16fn8-marker)A failed user request isn’t necessarily problematic. User requests can fail because the user requested something unreasonable, such as accessing a nonexistent URL. We need to be disciplined in distinguishing errors like these from problems in the systems.

[Chapter 15 - Configuration Specifics](/workbook/configuration-specifics/)

[Part III - Processes](/workbook/part-III-processes/)
