...
Generated: `2026-05-29T07:14:27+08:00`
...
|---|---:|---:|---:|---:|---|
| `post_target_collapse_or_live_mfe_giveback` | 5 | 0 | 4 | 1 | NO-GO |
| `dead_flow_timeout` | 0 | 0 | 0 | 7 | NO-GO |
| `entry_slippage_failure` | n/a | n/a | n/a | 0 | NO-GO |

## Decision

`NO_GO_FOR_LIVE_RULE`: validation_positives is 0, below the >=3 support gate. No candidate bucket has >=3 positives in validation, final, and live with a replay-equivalent label. The best-supported post-target direction has train=5, validation=0, final=4, live=1.
...
- Live `mfe_then_giveback`: `Binance light source`
- Live `dead_flow_timeout`: ``
- Live `entry_slippage_failure`: ``
- Live `profitable_exit`: `币安光源`
