...
* [Top](#top)
* [A Toggling Tale](#ATogglingTale)
  + [The birth of a Feature Flag](#TheBirthOfAFeatureFlag)
  + [Making a flag dynamic](#MakingAFlagDynamic)
  + [Getting ready to release](#GettingReadyToRelease)
  + [Canary releasing](#CanaryReleasing)
  + [A/B testing](#AbTesting)
* [Categories of toggles](#CategoriesOfToggles)
  + [Release Toggles](#ReleaseToggles)
  + [Experiment Toggles](#ExperimentToggles)
  + [Ops Toggles](#OpsToggles)
  + [Permissioning Toggles](#PermissioningToggles)
  + [Managing different categories of toggles](#ManagingDifferentCategoriesOfToggles)
    - [static vs dynamic toggles](#StaticVsDynamicToggles)
    - [Long-lived toggles vs transient toggles](#Long-livedTogglesVsTransientToggles)
* [Implementation Techniques](#ImplementationTechniques)
  + [De-coupling decision points from decision logic](#De-couplingDecisionPointsFromDecisionLogic)
  + [Inversion of Decision](#InversionOfDecision)
  + [Avoiding conditionals](#AvoidingConditionals)
* [Toggle Configuration](#ToggleConfiguration)
  + [Dynamic routing vs dynamic configuration](#DynamicRoutingVsDynamicConfiguration)
  + [Prefer static configuration](#PreferStaticConfiguration)
  + [Approaches for managing toggle configuration](#ApproachesForManagingToggleConfiguration)
  + [Hardcoded Toggle Configuration](#HardcodedToggleConfiguration)
  + [Parameterized Toggle Configuration](#ParameterizedToggleConfiguration)
  + [Toggle Configuration File](#ToggleConfigurationFile)
  + [Toggle Configuration in App DB](#ToggleConfigurationInAppDb)
  + [Distributed Toggle Configuration](#DistributedToggleConfiguration)
  + [Overriding configuration](#OverridingConfiguration)
    - [Per-request overrides](#Per-requestOverrides)
* [Working with feature-flagged systems](#WorkingWithFeature-flaggedSystems)
  + [Expose current feature toggle configuration](#ExposeCurrentFeatureToggleConfiguration)
  + [Take advantage of structured Toggle Configuration files](#TakeAdvantageOfStructuredToggleConfigurationFiles)
  + [Manage different toggles differently](#ManageDifferentTogglesDifferently)
  + [Feature Toggles introduce validation complexity](#FeatureTogglesIntroduceValidationComplexity)
  + [Where to place your toggle](#WhereToPlaceYourToggle)
    - [Toggles at the edge](#TogglesAtTheEdge)
    - [Toggles in the core](#TogglesInTheCore)
  + [Managing the carrying cost of Feature Toggles](#ManagingTheCarryingCostOfFeatureToggles)
...
[![Photo of Pete Hodgson](feature-toggles/pete-hodgson.png)](https://thepete.net)

[Pete Hodgson](https://thepete.net)

Pete Hodgson is an [independent software delivery consultant](https://thepete.net) based in the beautiful, rainy Pacific Northwest. He specializes in helping startup engineering teams improve their engineering practices and technical architecture.
...
```
function createInvoiceEmailler(config){ return { generateInvoiceEmail(){ const baseEmail = buildEmailForInvoice(this.invoice); if( config.includeOrderCancellationInEmail ){ return addOrderCancellationContentToEmail(email); }else{ return baseEmail; } }, // ... other invoice emailer methods ... }; }
```
...
```
function createInvoiceEmailler(additionalContentEnhancer){ return { generateInvoiceEmail(){ const baseEmail = buildEmailForInvoice(this.invoice); return additionalContentEnhancer(baseEmail); }, // ... other invoice emailer methods ... }; }
```
...
```
<%= if featureDecisions.showRecommendationsSection? %> <%= render 'recommendations_section' %> <% end %>
```
