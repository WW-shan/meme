...
The discussion of the event-driven backtesting implementation has previously considered the [event-loop](https://www.quantstart.com/articles/Event-Driven-Backtesting-with-Python-Part-I), the [event class hierarchy](https://www.quantstart.com/articles/Event-Driven-Backtesting-with-Python-Part-II) and the [data handling component](https://www.quantstart.com/articles/Event-Driven-Backtesting-with-Python-Part-III). In this article a Strategy class hierarchy will be outlined. `Strategy` objects take market data as input and produce trading *signal* events as output.
