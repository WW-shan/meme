...
try:
    ...
    class CatBoostRanker:  # type: ignore[override]
        def __init__(self, *args, **kwargs):
            raise ModuleNotFoundError("catboost is required to use CandidateRankCatBoostModel")
...
DEFAULT_CATBOOST_RANKER_PARAMS = {
    "iterations": 500,
    "learning_rate": 0.05,
    "depth": 5,
    "l2_leaf_reg": 10.0,
