...
def parse_args(argv=None):
    parser = argparse.ArgumentParser(description="Run a bounded primary-score scalp overlay replay grid")
...
def candidate_grid():
    ...
    for values in itertools.product(
        ...
        min_prob, min_pred_return, min_volume, min_volatility, take_profit = values
        yield {
...
def _acceptance_gate():
    return {
        ...
        "requires_quick_profit_overlay_entries": True,
    }
...
def _gate_details(candidate_summary, baseline_summary):
    ...
    return {
        ...
        "quick_profit_overlay_entry_count": candidate_summary["quick_profit_overlay_entry_count"] > 0,
    }
