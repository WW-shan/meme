...
def parse_args(argv=None):
    ...
    parser.add_argument("--max-open-positions", type=int, default=None, help="Override maximum simultaneous open positions from the model manifest")
    ...
    parser.add_argument("--min-entry-price-volatility", type=float, default=None, help="Override minimum price volatility feature required to buy")
